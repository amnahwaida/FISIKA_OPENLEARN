...
$$ \sin \theta_k = \frac{n_{\text{renggang}}}{n_{\text{rapat}}} = \frac{n_2}{n_1} $$
...
$$ P = \frac{1}{f \text{ (dalam meter)}} \quad \text{atau} \quad P = \frac{100}{f \text{ (dalam cm)}} $$
...
$$ \frac{1}{f} = \left(\frac{n_{\text{lensa}}}{n_{\text{medium}}} - 1 \right) \left( \frac{1}{R_1} + \frac{1}{R_2} \right) $$
...
- **Reparasi Lensa Kacamata (-) Minus Tipe Cekung Pembuka Sudut:**
  $$ P_{\text{Miopi}} = -\frac{100}{PR (\text{dalam cm})} $$
...
- **Reparasi Kacamata Bikonveks (+) Positif Kuat:**
  $$ P_{\text{Hiper}} = 4 - \frac{100}{PP (\text{dalam cm})} \quad \text{*(Asumsi murni Sn = 25 cm)*} $$
...
$$ M = \frac{f_{\text{ob}}}{f_{\text{ok}}} \qquad \text{Dan tabung terpotong panjang} \ d = f_{\text{ob}} + f_{\text{ok}} $$
